...
{
    public partial class FTransfer_A : Form
    {
...
/*
          ...
          private void Getdata(string cmd)
        {
          ...
          //  dataGridView1.Columns["Quan1"].ReadOnly = true;
            ...
            dataGridView1.Columns["FStockName"].Width = 100;
            ...
            dataGridView1.Columns["FStockNoALL"].Width = 120;
            ...
            dataGridView1.Columns["FUnit"].Width = 40;
            ...
            dataGridView1.Columns["FRased"].Width = 50;
            ...
            dataGridView1.Columns["TStockName"].Width = 50;
           ...
           dataGridView1.Columns["TRased"].HeaderText = "79/72";//col16
            dataGridView1.Columns["TRased"].Width = 50;
        ...
        public void UpdateQuan2()
        {
            ...
            foreach (DataGridViewRow row in dataGridView1.Rows)
            {
                ...
                if (!row.IsNewRow)
                {
                    ...
                    string cmdstring = "Exec SP_UpdateQuanTsnif @Quan,@ST,@F,@EZ,@FY,@B";
