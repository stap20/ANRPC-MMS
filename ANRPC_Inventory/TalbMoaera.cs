...
{
    public partial class TalbMoaera : Form
    {
        //------------------------------------------ Define Variables ---------------------------------
        ...
        #region Helpers
            ...
            public void SP_UpdateSignatures(int x, DateTime D1, DateTime? D2 = null)
            {
                ...
                cmd.Parameters.AddWithValue("@FN",9);
            ...
            private void InsertTalbTawreedBnood()
            {
                ...
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    if (!row.IsNewRow)
                    {
                        string q = @"exec SP_InsertBnodTalbMoaera @TalbTwareed_No,@FYear,@Bnd_No,@RequestedQuan,
...
/*
            ...
            private void GetTalbTawreedBnod(string talbNo, string fyear)
        {
            ...
            string TableQuery = @"SELECT  [Moaera_No] ,[FYear],[Bnd_No],[RequestedQuan],Unit,[BIAN_TSNIF] ,[ArrivalDate] ,
                                ApproxValue,Moaera_No2 FROM [T_TalbMoaera_Benod] 
                                Where Moaera_No = " + talbNo + " and Fyear='" + fyear + "'";
            ...
            dataGridView1.Columns["Moaera_No"].HeaderText = "رقم طلب معايرة";//col0
          ...
          //  dataGridView1.Columns["Quan"].HeaderText = "رصيد المخزن";//col7
           ...
           // dataGridView1.Columns["NewTasnifFlag"].HeaderText = "تصنيف جديد";//col11
            ...
            dataGridView1.Columns["Moaera_No2"].HeaderText = "رقم طلب معايرة";//col8
            dataGridView1.Columns["Moaera_No2"].Visible = false;
            ...
            public bool SearchTalb(string talbNo, string fyear, bool isCompleted = false)
            {
                ...
                if (isCompleted)
                {
                    cmdstring = "select * from  T_TalbMoaera where Moaera_No2=@TN and FYear=@FY";
                }
                else
                {
                    cmdstring = "select * from  T_TalbMoaera where Moaera_No=@TN and FYear=@FY";
                }
                ...
                if (dr.HasRows == true)
                {
                    try
                    {
                        while (dr.Read())
                        {
                            ...
                            TXT_TalbNo.Text = dr["Moaera_No"].ToString();
                            TXT_TalbNo2.Text = dr["Moaera_No2"].ToString();
                        ...
                        TXT_Edara.Text = dr["NameEdara"].ToString();
                            ...
                            if (s1 != "")
                            {
                                string p = Constants.RetrieveSignature("1", "9", s1);
                            ...
                            if (s2 != "")
                            {
                                string p = Constants.RetrieveSignature("2", "9", s2);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                            ...
                            if (s3 != "")
                            {
                                string p = Constants.RetrieveSignature("3", "9", s3);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                            ...
                            if (s4 != "")
                            {
                                string p = Constants.RetrieveSignature("4", "9", s4);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                            ...
                            if (s5 != "")
                            {
                                string p = Constants.RetrieveSignature("5", "9", s5);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                            ...
                            if (s6 != "")
                            {
                                string p = Constants.RetrieveSignature("6", "9", s6);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                            ...
                            if (s7 != "")
                            {
                                string p = Constants.RetrieveSignature("7", "9", s7);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                            ...
                            if (s8 != "")
                            {
                                string p = Constants.RetrieveSignature("8", "9", s8);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                            ...
                            if (s9 != "")
                            {
                                string p = Constants.RetrieveSignature("9", "9", s9);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                            ...
                            if (s11 != "")
                            {
                                string p = Constants.RetrieveSignature("11", "9", s11);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                            ...
                            if (s12 != "")
                            {
                                string p = Constants.RetrieveSignature("12", "9", s12);
                                if (p != "")
                                {
                                    //   Pic_Sign1
                                    //	"Pic_Sign1"	string
                ...
                {
                    MessageBox.Show("من فضلك تاكد من رقم طلب معايرة");
                    reset();
                    return false;
                }
        ...
        private void AddLogic()
        {
            ...
            string cmdstring = @"Exec SP_InsertTalbMoaera @TalbTwareed_No,@FYear,@CreationDate,@CodeEdara,@NameEdara,
...
/*
            ...
            {
                MessageBox.Show("تم إدخال رقم طلب معايرة  من قبل  ! ");
            }
            else if (executemsg == false)
            {
                MessageBox.Show("لم يتم إدخال طلب معايرة بنجاج!!");
            }
            Constants.closecon();
        }
        ...
        private void UpdateTalbTawreedStepsAndNotification()
        {
            ...
            if (FlagSign6 == 1 && Constants.UserTypeB == "GMInventory")
            {
                ...
                string q = "exec  SP_UpdateTalbMoaeraNo2  @p1,@p2,@p22,@p3 out";
                Constants.opencon();
                cmd = new SqlCommand(q, Constants.con);
                cmd = new SqlCommand(q, Constants.con);
                cmd.Parameters.AddWithValue("@p1", TXT_TalbNo.Text);
            ...
            if (FlagSign5 == 1)
            {
                ...
                try
                {
                    ...
                    if (flag2 == 1)
                    {
                        ...
                        string q = "exec SP_UpdateTalbMoaeraAuthority  @p1,@p2,@p3";
         ...
         */
            ...
            /////////////////////////////////////////////
            string cmdstring = @"Exec SP_UpdateTalbMoaera @TT,@FY,@TalbTwareed_No,@TalbTwareed_No2,@FYear,@CreationDate,@CodeEdara,
            ...
            {
                MessageBox.Show("طلب معايرة المراد تعديله غير موجود !!");
            }
            Constants.closecon();
        }
        ...
        public bool DeleteTalb()
        {
            ...
            if ((MessageBox.Show("هل تريد حذف طلب معايرة؟", "", MessageBoxButtons.YesNo)) == DialogResult.Yes)
            {
                if (string.IsNullOrWhiteSpace(TXT_TalbNo.Text))
                {
                    MessageBox.Show("يجب اختيار طلب معايرةاولا");
                    return false;
                }
                Constants.opencon();
          /*    string cmdstring1 = "select STOCK_NO_ALL,AdditionStockFlag,Bnd_No from T_TalbTawreed_Benod where FYear=@FY and TalbTwareed_No=@TNO";
                ...
                */
                string cmdstring = "Exec SP_DeleteTalbMoaera @TNO,@FY,@aot output";
        ...
        private List<(ErrorProvider, Control, string)> ValidateSave()
        {
            ...
            if (dataGridView1.Rows.Count <=0)
            {
                ...
                MessageBox.Show("لايمكن ان يتكون طلب معايرة بدون بنود");
            }
        ...
        public TalbMoaera(string x, string y)
        {
            InitializeComponent();
            Cmb_FYear.Text = x;
            TXT_TalbNo.Text = y;
        ...
        private void TalbTawred_Load(object sender, EventArgs e)
        {
            ...
            AddEditFlag = 0;
            if (Constants.TalbMoaera_F == false)
            {
                panel7.Visible = true;
                panel2.Visible = false;
                panel7.Dock = DockStyle.Top;
            }
            else if (Constants.TalbMoaera_F == true)
            {
                panel2.Visible = true;
            ...
            string cmdstring3 = "SELECT [Moaera_No] from T_TalbMoaera where CodeEdara=" + Constants.CodeEdara + " and  FYear='" + Cmb_FYear.Text + "'";
            ...
            if (dr3.HasRows == true)
            {
                while (dr3.Read())
                {
                    TalbColl.Add(dr3["Moaera_No"].ToString());

                }
            }
            dr3.Close();
            ///////////////////
            string cmdstring4 = "SELECT [Moaera_No2] from T_TalbMoaera where CodeEdara=" + Constants.CodeEdara + " and  FYear='" + Cmb_FYear.Text + "'";
            ...
            if (dr4.HasRows == true)
            {
                while (dr4.Read())
                {
                    TalbColl2.Add(dr4["Moaera_No2"].ToString());
        ...
        {
            if ((MessageBox.Show("هل تريد اضافة طلب معايرة جديد؟", "", MessageBoxButtons.YesNo)) == DialogResult.Yes)
            {
                reset();
                PrepareAddState();
                AddEditFlag = 2;
        ...
        private void CHK_NewTasnif_CheckedChanged(object sender, EventArgs e)
        {
            if (CHK_NewTasnif.Checked == true)
            {
                ...
                Addbtn2.Text = "إضافة التصنيف الى طلب معايرة مهمات";
            }
            else
            {
                HandleExistTasnifState();
                Addbtn2.Text = "إضافة التصنيف الى طلب معايرة";
            }
        }
        ...
        private void Cmb_FYear_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (AddEditFlag == 0)
            {
                ...
                if (Constants.User_Type == "A")
                {
                    cmdstring3 = "SELECT [Moaera_No] from T_TalbMoaera where CodeEdara=" + Constants.CodeEdara + " and  FYear='" + Cmb_FYear.Text + "'";

                }
                else
                {
                    cmdstring3 = "SELECT [Moaera_No] from T_TalbMoaera where  FYear='" + Cmb_FYear.Text + "'";
            ...
            if (AddEditFlag == 2)//add
            {
                ...
                string cmdstring = "select ( COALESCE(MAX(Moaera_No), 0)) from  T_TalbMoaera where FYear=@FY ";
                ...
                try
                {
                    ...
                    if (count != null && count != DBNull.Value)
                    {
                        ...
                        ///////////////////////////////
                        string cmdstring2 = "select ( COALESCE(MAX(Moaera_No), 0)) from  T_TempMoaeraNo where FYear=@FY ";
                        ...
                        /////// insert temp table//////////////
                        string query = "exec SP_InsertTempMoaera_No @p1,@p2";
                        SqlCommand cmd1 = new SqlCommand(query, Constants.con);
        ...
        private void Editbtn_Click_1(object sender, EventArgs e)
        {
            if ((MessageBox.Show("هل تريد تعديل طلب معايرة ؟", "", MessageBoxButtons.YesNo)) == DialogResult.Yes)
            {
                ...
                {
                    MessageBox.Show("يجب اختيار طلب معايرة المراد تعديله");
                    return;
                }
        ...
        private void Cmb_FYear2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)  and(Sign8 is not null )  and (Sign11 is not null )and( Stock_Sign is not null) and (Sign9 is  not null) and( CH_Sign is not  null) and Audit_Sign is not null and RedirectedFor='" + Constants.FlagRedirectEmpn + "'";

            }
            else if (Constants.User_Type == "A")
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and CodeEdara=@CE  and(( Confirm_Sign1 is  null) or( Confirm_Sign2 is  null)) ";

            }
            else if (Constants.User_Type == "B" && Constants.UserTypeB == "Stock")
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)  and(Sign8 is not null )  and (Sign11 is not null )and( Stock_Sign is not null) and (Sign9 is not  null) and CH_Sign is not null and (Audit_Sign is not null) and (Mohmat_Sign is null)";

            }
            else if (Constants.User_Type == "B" && Constants.UserTypeB == "Purchases")
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)  and (Sign11 is not null )  and( Stock_Sign is not  null) and (Audit_Sign is null)";

            }

            else if (Constants.User_Type == "B" && Constants.UserTypeB == "GMInventory")
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)   and (Sign11 is not null ) and( Stock_Sign is not null) and (Sign9 is not  null) and CH_Sign is not null and (Audit_Sign is not null )and Mohmat_Sign is null";
            ...
            */
            ...
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)  and (Sign11 is null or Stock_Sign is null)";

            }

            else if (Constants.User_Type == "B" && Constants.UserTypeB == "TechnicalFollowUp")
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)    and (Sign11 is not null )    and( Stock_Sign is not null) and (Audit_Sign is not null ) and (Sign9 is null)";
            }
            ...
            else if (Constants.User_Type == "B" && Constants.UserTypeB == "Chairman")
            {
               // cmdstring = "select (Eslah_No) from  T_TalbEslah where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)  and(Sign8 is not null )  and (Sign11 is not null )and (Sign12 is not null )  and( Stock_Sign is not null) and (Sign9 is  not null) and( CH_Sign is null)";
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)    and (Sign11 is not null ) and( Stock_Sign is not null) and (Sign9 is  not null) and( CH_Sign is null)";

            }

            else if (Constants.User_Type == "B" && Constants.UserTypeB == "ViceChairman")
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)   and (Sign11 is not null ) and( Stock_Sign is not null)  and( Sign13 is null)";

            }
            else if (Constants.User_Type == "B" && Constants.UserTypeB == "Purchases")
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Confirm_Sign1 is not null) and( Confirm_Sign2 is not null)  and (Sign11 is not null )  and( Stock_Sign is not null) and (Sign9 is  not null) and( CH_Sign is not  null) and Audit_Sign is null";
            ...
            */
            ...
            {
                cmdstring = "select (Moaera_No) from  T_TalbMoaera where FYear=@FY and( Mohmat_Sign is not null)  ";
            ...
            Cmb_TalbNo2.ValueMember = "Moaera_No";
            Cmb_TalbNo2.DisplayMember = "Moaera_No";
            Cmb_TalbNo2.SelectedIndex = -1;
        ...
        private void reInitDataGridView(DataTable table)
        {
            ...
            dataGridView1.Columns["Moaera_No"].HeaderText = "رقم طلب معايرة";//col0
            dataGridView1.Columns["Moaera_No"].ReadOnly = true;
...
///
        ...
        private void BTN_PDF_Click(object sender, EventArgs e)
        {
            ...
            if (AddEditFlag == 0)//search
            {
                ...
                popup.WholePath = @"\\172.18.8.83\MaterialAPP\PDF\" + currentcodeedara + @"\"+ Cmb_FYear.Text + @"\TALB_Moaera\"+ TXT_TalbNo.Text + @"\";
            }
            else//add or edit
            {
                //popup.TalbNo = TXT_TalbNo.Text;
                ...
                popup.WholePath = @"\\172.18.8.83\MaterialAPP\PDF\" + Constants.CodeEdara + @"\" + Cmb_FYear.Text + @"\TALB_Moaera\" + TXT_TalbNo.Text + @"\";
            }
            try
            {
        ...
        private void BTN_Sign1_Click(object sender, EventArgs e)
        {
           // LoopGridview();
            ...
            if (Sign1 != "" && Empn1 != "")
            {
                ...
                Tuple<string, int, int, string, string> result = Constants.CheckSign("1", "9", Sign1, Empn1);
                if (result.Item3 == 1)
                {
        ...
        private void BTN_Sign2_Click(object sender, EventArgs e)
        {
           // LoopGridview();
            ...
            if (Sign2 != "" && Empn2 != "")
            {
                //  MessageBox.Show("done");
                // string result= Constants.CheckSign("1",Sign1);
                Tuple<string, int, int, string, string> result = Constants.CheckSign("2", "9", Sign2, Empn2);
                if (result.Item3 == 1)
                {
        ...
        private void BTN_Sign3_Click(object sender, EventArgs e)
        {
          //  LoopGridview();
            ...
            if (Sign3 != "" && Empn3 != "")
            {
                ...
                Tuple<string, int, int, string, string> result = Constants.CheckSign("3", "9", Sign3, Empn3);
                if (result.Item3 == 1)
                {
        ...
        private void BTN_Sign8_Click(object sender, EventArgs e)
        {
           ...
           // LoopGridview();
            ...
            if (Sign8 != "" && Empn8 != "")
            {
                //  MessageBox.Show("done");
                // string result= Constants.CheckSign("1",Sign1);
                Tuple<string, int, int, string, string> result = Constants.CheckSign("8", "9", Sign8, Empn8);
                if (result.Item3 == 1)
                {
        ...
        private void BTN_Sign12_Click(object sender, EventArgs e)
        {
            ...
            if (Sign12 != "" && Empn12 != "")
            {
                //  MessageBox.Show("done");
                // string result= Constants.CheckSign("1",Sign1);
                Tuple<string, int, int, string, string> result = Constants.CheckSign("12", "9", Sign12, Empn12);
                if (result.Item3 == 1)
                {
        ...
        private void BTN_Sign4_Click(object sender, EventArgs e)
        {
           // LoopGridview();
            ...
            if (Sign4 != "" && Empn4 != "")
            {
                //  MessageBox.Show("done");
                // string result= Constants.CheckSign("1",Sign1);
                Tuple<string, int, int, string, string> result = Constants.CheckSign("4", "9", Sign4, Empn4);
                if (result.Item3 == 1)
                {
        ...
        private void BTN_Sign11_Click(object sender, EventArgs e)
        {
            ...
            if (Sign11 != "" && Empn11 != "")
            {
                //  MessageBox.Show("done");
                // string result= Constants.CheckSign("1",Sign1);
                Tuple<string, int, int, string, string> result = Constants.CheckSign("11", "9", Sign11, Empn11);
                if (result.Item3 == 1)
                {
        ...
        private void BTN_Sign5_Click(object sender, EventArgs e)
        {
            ...
            if (Sign5 != "" && Empn5 != "")
            {
                //  MessageBox.Show("done");
                // string result= Constants.CheckSign("1",Sign1);
                Tuple<string, int, int, string, string> result = Constants.CheckSign("5", "9", Sign5, Empn5);
                if (result.Item3 == 1)
                {
        ...
        private void BTN_Sign13_Click(object sender, EventArgs e)
        {
            ...
            if (Sign13 != "" && Empn13 != "")
            {
                //  MessageBox.Show("done");
                // string result= Constants.CheckSign("1",Sign1);
                Tuple<string, int, int, string, string> result = Constants.CheckSign("13", "9", Sign13, Empn13);
                if (result.Item3 == 1)
                {
        ...
        private void BTN_Sign7_Click(object sender, EventArgs e)
        {
            ...
            if (Sign7 != "" && Empn7 != "")
            {
                //  MessageBox.Show("done");
                // string result= Constants.CheckSign("1",Sign1);
                Tuple<string, int, int, string, string> result = Constants.CheckSign("7", "9", Sign7, Empn7);
                if (result.Item3 == 1)
                {
