...
{
    public partial class TalbTnfizTabsHandler : Form
    {
        ...
        {
            Constants.TalbTanfiz_F = true;

            TabBarBtnCLicked(sender, e, RGBColors.color1, new TalbTnfiz());
        }

        private void btnFollowSignature_Click(object sender, EventArgs e)
        {
            Constants.TalbTanfiz_F = false;
