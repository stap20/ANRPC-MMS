...
{
    public partial class TalbMoaeraTabsHandler : Form
    {
        ...
        {
            Constants.TalbMoaera_F = true;

            TabBarBtnCLicked(sender, e, RGBColors.color1, new TalbMoaera());
        }

        private void btnFollowSignature_Click(object sender, EventArgs e)
        {
            Constants.TalbMoaera_F = false;
