...
{
    public partial class EznSarfTabsHandler : Form
    {
        ...
        {
            Constants.EznSarf_FF = true;

            SideBarBtnCLicked(sender, e, RGBColors.color1, new EznSarf_F());
        }
