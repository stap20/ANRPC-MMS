...
{
    public partial class Search_TalbTawreed : Form
    {
        public int StepFlag;
       ...
       */
        ...
        private void Cmb_FYear2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                cmdstring = "select (TalbTwareed_No) from  T_TalbTawreed where FYear=@FY and CreationDate between @D1 and @D2 ";
            }
    ...
    toolTip2.SetToolTip(this.Cmb_Edara, Cmb_Edara.SelectedText.ToString());
      */
        ...
        private void BTN_Form_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("يجب اختيار السنة المالية و رقم طلب التوريد اولا");
                return;
