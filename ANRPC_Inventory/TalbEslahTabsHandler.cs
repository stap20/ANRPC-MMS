...
{
    public partial class TalbEslahTabsHandler : Form
    {
        ...
        {
            Constants.talbEslah_F = true;

            TabBarBtnCLicked(sender, e, RGBColors.color1, new TalbEslah());
        }

        private void btnFollowSignature_Click(object sender, EventArgs e)
        {
            Constants.talbEslah_F = false;
